...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.gros_sacha.setPixmap(QtGui.QPixmap("../data/images/divers/sacha.png"))
        ...
        self.save_button.setGeometry(QtCore.QRect(10, 80, 93, 28))
        self.save_button.setObjectName("save_button")
        
        self.coeur3 = QtWidgets.QLabel(self.centralwidget)
        self.coeur3.setGeometry(QtCore.QRect(980, 10, 61, 61))
        self.coeur3.setText("")
        self.coeur3.setPixmap(QtGui.QPixmap("../data/images/divers/coeur.png"))
        ...
        self.coeur2.setText("")
        self.coeur2.setPixmap(QtGui.QPixmap("../data/images/divers/coeur.png"))
        ...
        self.coeur1.setText("")
        self.coeur1.setPixmap(QtGui.QPixmap("../data/images/divers/coeur.png"))
        ...
        self.gameover.setPixmap(QtGui.QPixmap("../data/images/divers/gameover.png"))
        ...
        self.pokemon_sauvage.setPixmap(QtGui.QPixmap("../data/images/divers/pikachu.png"))
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../data/images/divers/logo.png"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        
        self.play = QtWidgets.QPushButton(self.centralwidget)
        self.play.setGeometry(QtCore.QRect(320, 380, 111, 41))
        self.play.raise_()
        font = QtGui.QFont()
        ...
        self.new_game.setGeometry(QtCore.QRect(475, 380, 111, 41))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI Semibold")
        font.setPointSize(11)
        self.new_game.setFont(font)
        self.new_game.setAutoFillBackground(True)
        self.new_game.setObjectName("new_game")
        
        self.inventory2 = QtWidgets.QPushButton(self.centralwidget)
        self.inventory2.setGeometry(QtCore.QRect(630, 380, 111, 41))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI Semibold")
        font.setPointSize(11)
        ...
        self.maison.setPixmap(QtGui.QPixmap("../data/images/divers/maison.png"))
        self.maison.setText("")
        self.maison.setObjectName("maison")

        
        self.sacha = QtWidgets.QLabel(self.centralwidget)
        self.sacha.setGeometry(QtCore.QRect(self.width() / 2, self.height() / 2, 19 * self.scale, 25 * self.scale))
        #self.sacha.setGeometry(QtCore.QRect(540, 364, 24, 24))
        self.sacha.setText("")
        self.sacha.setPixmap(QtGui.QPixmap("../data/images/animation/down0.png"))
        #self.sacha.setPixmap(QtGui.QPixmap("../data/images/animation/cara.png"))
        ...
        self.fondcombat.setPixmap(QtGui.QPixmap("../data/images/divers/fond combat.PNG"))
        ...
        self.progressBar_notre.setGeometry(QtCore.QRect(140, 210, 321, 23))
        font = QtGui.QFont()
        ...
        self.progressBarpokesauvage.setGeometry(QtCore.QRect(660, 210, 321, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(20)
        ...
        self.level_poke_sauvage = QtWidgets.QLabel(self.centralwidget)
        self.level_poke_sauvage.setGeometry(QtCore.QRect(660, 250, 100, 91))
        font = QtGui.QFont()
        font.setPointSize(15)
        
        self.level_poke_sauvage.setFont(font)
        self.level_poke_sauvage.setAlignment(QtCore.Qt.AlignCenter)
        self.level_poke_sauvage.setObjectName("level_poke_sauvage")
        self.level_poke_sauvage.setText("lvl. 100")
        
        self.level_notre_poke = QtWidgets.QLabel(self.centralwidget)
        self.level_notre_poke.setGeometry(QtCore.QRect(140, 250, 100, 91))
        font = QtGui.QFont()
        font.setPointSize(15)
        
        self.level_notre_poke.setFont(font)
        self.level_notre_poke.setAlignment(QtCore.Qt.AlignCenter)
        self.level_notre_poke.setObjectName("level_notre_poke")
        self.level_notre_poke.setText("lvl. 100")
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(255, 255, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        self.level_notre_poke.setPalette(palette)
        self.level_poke_sauvage.setPalette(palette)
        
        
        
        self.gridLayoutWidget = QtWidgets.QWidget(MainWindow)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(80, 545, 361, 111))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(490, 545, 160, 100))
        ...
        self.widget.setGeometry(QtCore.QRect(355, 240, 361, 161))
        ...
        self.areyousure.setGeometry(QtCore.QRect(105, 20, 200, 50 ))
        font.setPointSize(12)
        self.areyousure.setFont(font)
        self.areyousure.setStyleSheet("background-color:rgb(16,164,164);\n""border: 2px solid yellow")
        self.areyousure.setFont(font)
        self.areyousure.setObjectName("areyousure")
        
        self.infos_combat = QtWidgets.QLabel(self.centralwidget)
        self.infos_combat.setGeometry(QtCore.QRect(0, 550, self.width(), self.height() - 550 - 20))
        font = QtGui.QFont()
        font.setPointSize(25)
        self.infos_combat.setFont(font)
        self.infos_combat.setStyleSheet("background-color:rgb(16,164,164);\n""border: 5px solid yellow")
        self.infos_combat.setAlignment(QtCore.Qt.AlignCenter)
        self.infos_combat.setObjectName("infos_combat")
        ...
        self.inventairemarron.setPixmap(QtGui.QPixmap("../data/images/divers/inventory.png"))
        ...
        self.fontgris.setGeometry(QtCore.QRect(0, 0, self.width(), self.height()))
        self.fontgris.setText("")
        self.fontgris.setPixmap(QtGui.QPixmap("../data/images/divers/map_assombrie.png"))
        ...
        self.image1.setText("")
        self.image1.setPixmap(QtGui.QPixmap("../data/images/divers/pikachu.png"))
        ...
        self.couronne1.setPixmap(QtGui.QPixmap("../data/images/divers/couronne.png"))
        ...
        self.couronne2.setPixmap(QtGui.QPixmap("../data/images/divers/couronne.png"))
        ...
        self.couronne3.setPixmap(QtGui.QPixmap("../data/images/divers/couronne.png"))
        ...
        self.couronne4.setPixmap(QtGui.QPixmap("../data/images/divers/couronne.png"))
        ...
        self.couronne5.setPixmap(QtGui.QPixmap("../data/images/divers/couronne.png"))
        ...
        self.couronne6.setPixmap(QtGui.QPixmap("../data/images/divers/couronne.png"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.setWindowIcon(QtGui.QIcon("../data/images/divers/pokeball"))
        self.inventory.setText(_translate("MainWindow", "Inventory"))
        self.save_button.setText(_translate("MainWindow", "Save"))
        self.play.setText(_translate("MainWindow", "Continue"))
